...
Group8/RotationInZ.o: Group8/RotationInZ.c Group8/RotationInZ.h main.h
	$(CC) $(CFLAGS) -c Group8/RotationInZ.c -o Group8/RotationInZ.o
...
Group8/RotationInZTests.o: Group8/RotationInZTests.c Group8/RotationInZTests.h main.h
	$(CC) $(CFLAGS) -c Group8/RotationInZTests.c -o Group8/RotationInZTests.o
