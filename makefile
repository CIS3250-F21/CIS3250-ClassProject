...
zScaling/zScaling.o: zScaling/zScaling.c zScaling/zScaling.h main.h
	$(CC) $(CFLAGS) -c zScaling/zScaling.c -o zScaling/zScaling.o
...
zScaling/zScalingTests.o: zScaling/zScalingTests.c zScaling/zScalingTests.h main.h
	$(CC) $(CFLAGS) -c zScaling/zScalingTests.c -o zScaling/zScalingTests.o
