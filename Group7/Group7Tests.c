...
void runTests() {
    ...
    // Dirty Tests
    testHandler(testGetVectorReturnsNullWhenIndexIsNeagtive, "Test Get Vector Returns Null When Index Is Negative");

    testHandler(testGetVectorReturnsNullWhenIndexIsGreaterThanLength, "Test Get Vector Returns Null When Index Is Greater Then Length");

    // Clean Tests
    testHandler(testGetVectorReturnsMatchingVector, "Test Get Vector Returns Matching Vector ");

    // setVector Tests //

    // Dirty Tests
    testHandler(testSetVectorReturn0WhenIndexIsNegative, "Test Set Vector If Returns 0 When Index Negative.");

    testHandler(testSetVectorReturn0WhenIndexIsGreaterThenLength, "Test Set Vector If Returns 0 When Index Greater Than Length.");

    testHandler(testSetVectorReturn0IfVectorIsNull, "Test Set Vector If Returns 0 When Vector is Null");

    // Clean Tests
    testHandler(testSetVectorIfVectorAddedAtIndex, "Test Set Vector If Vector Added At Index");

    // getYRotation Tests //

    testHandler(testGetYRotation, "Test Get Y Rotation");

    // setYRotation Tests
    testHandler(testSetYRotationWhenAngleIsValid, "Test Set Y Rotation When Angle Is valid");

    // generateYRotationMatrix tests
    testHandler(testGenerateYRotationMatrixWhenTransformationMatrixIsNull, "Test Generate Y Rotation Matrix When Transformation Matrix is Null");

    testHandler(testGenerateYRotationMatrixWhenElementOfTransformationMatrixIsNull, "Test Generate Y Rotation Matrix When Element Of Transformation Matrix Is Null");

    testHandler(testGenerateYRotationMatrixWhenElementOfTransformationMatrixIsNull, "Test Generate Y Rotation Matrix When Element Of Transformation Matrix Is Null");

    testHandler(testGenerateYRotationMatrixWhenAngleIs0, "Test Generate Y Rotation Matrix When Angle Is 0");

    testHandler(testGenerateYRotationMatrixWhenAngleIsNegative, "Test Generate Y Rotation Matrix When Angle Is Negative");

    testHandler(testGenerateYRotationMatrixWhenAngleIsPositiveGreaterThanTwoPi, "Test Generate Y Rotation Matrix When Angle Is Positive Greater Then Two Pi");

    // Matrix Multiplication Tests //

    // Dirty tests
    testHandler(testMatrixMultiplicationWhenVectorIsNull, "Test Matrix Multiplication To Check For NULL Vector ");

    // Clean tests
    testHandler(testMatrixMultiplicationWhenVectorIsValid, "Test Matrix Multiplication Vectors Are Valid ");

    // Dirty YRotation Tests
    testHandler(testYRotationHandlesNullVectors, "Test Y Rotation Handles Null Vectors ");

    testHandler(testYRotationHandlesNullVector, "Test Y Rotation Handles Null Vector ");

    testHandler(testYRotationHandlesNullMatrix, "Test Y Rotation Handles Null Matrix ");

    testHandler(testYRotationHandlesNullElementOfMatrix, "Test Y Rotation Handles Null Element Of Matrix ");

    testHandler(testYRotationWhenAngleIsPositiveGreaterThanTwoPi, "Test Y Rotation When Angle Is Positive Greater Than Two Pi ");

    testHandler(testYRotationWhenAngleIsNegative, "Test Y Rotation When Angle Is Negative ");

    // Clean YRotation Tests
    testHandler(testYRotationWhenAngleIs0, "Test Y Rotation When Angle Is 0 ");
}
